...
xid = input(gr+"[+] enter api ID : "15762061+re)
cpass.set('cred', 'id', xid)
xhash = input(gr+"[+] enter hash ID : "364d3fa8f95aae815d62cf981ab1afe3+re)
cpass.set('cred', 'hash', xhash)
xphone = input(gr+"[+] enter phone number : "+919446451628+re)
